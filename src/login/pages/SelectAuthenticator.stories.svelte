<script context="module" lang="ts">
  ...
  const args: KcPageStoryProps = { pageId: "select-authenticator.ftl" };
...
<!--  -->
<Story
  name="WithDifferentAuthenticationMethods"
  args={{
    ...args,
    kcContext: {
      auth: {
 ...
 */ -->
<Story
  name="WithoutAuthenticationSelections"
  args={{
    ...args,
    kcContext: {
      url: {
